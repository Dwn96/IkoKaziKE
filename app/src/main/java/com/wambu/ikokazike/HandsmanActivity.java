...
public class HandsmanActivity extends Activity implements LocationCalcInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_handsman);
...
//        String userId = firebaseAuth.getCurrentUser().getUid();
        ...
        query = databasePainters.orderByChild("serviceCategory").equalTo("Handsman");


        recyclerViewServices = findViewById(R.id.recycler_Handsman);
    ...
    public void ReadPainters() {
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                client.getLastLocation().addOnSuccessListener(HandsmanActivity.this, new OnSuccessListener<Location>() {
                    @Override
                    public void onSuccess(Location location) {
                        ...
                        if (location != null) {
                            ...
                            CustomServiceAdapter serviceAdapter = new CustomServiceAdapter(HandsmanActivity.this, allPaintersList, latitude, longitude);
